...
export function generateUsernameForm(callback) {
    document.body.innerHTML = '<form><label for="username">Enter Username</label><input type="text" id="username"><input type="submit" value="Submit" id="submit_username"></form>';
