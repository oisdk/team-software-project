...
The repository is broken down into two sub-sections: [frontend](/frontend), which contains the client-side code, and </backend>, which contains the server-side code.
